...
class App_Date_Calc
{
	...
	/**
     * Returns the abbreviated weekday name for the day id
     *
     * @param int    $day     the id of the day in the week
     * @param int    $length  the length of abbreviation
     *
     * @return string  the abbreviated name of the day of the week
     *
     ...
     * @see Date_Calc::getWeekdayFullname()
	 */
	function getDayAbbrname($dayOfWeek, $length = 3){
		$LANG=$_SESSION["LANG"];
		$weekdays=$_SESSION["weekdays"];
		$dayList=$weekdays[$LANG];
		$res=substr($dayList[$dayOfWeek], 0, $length);
